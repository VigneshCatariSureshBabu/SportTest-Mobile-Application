...
class Liegestuetz extends StatefulWidget {
  const Liegestuetz({Key? key}) : super(key: key);

  @override
  State<Liegestuetz> createState() => _LiegestuetzState();
}
                        ...
                        MaterialButton(
                          ...
                          onPressed: () async {
                            await db
                                ...
                                .doc(_studentId.text)
                                .update(
                                    {'liegestuetz': int.parse(_anzahl.text)});
                            Navigator.pop(
                                context,
                                MaterialPageRoute(
